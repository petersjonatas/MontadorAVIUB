...
//curdate()
//"$data"
$sql = mysqli_query($cx, 'select * from `log_vendas` where date(`data`) = curdate()') or die( mysqli_error($cx));
...
<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
 ...
 <i class="fa fa-circle-o-notch fa-5x"></i>
                      <h4>ID: '.$aux["ID"].'<br>'.$aux["produtos"].'<br>Quantidade: '.$aux["quantidade"].'<br>Vendedor: '.$aux["vendedor"].'</h4>
