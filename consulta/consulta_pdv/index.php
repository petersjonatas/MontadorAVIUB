...
Data para verificação:<br>
<label>Dia (DD):</label><input type="text" class="form-control" name="dia" id="dia"><br>
<label>Mês (MM):</label><input type="text" class="form-control" name="mes" id="mes"><br>
<label>Ano (AAAA):</label><input type="text" class="form-control" name="ano" id="ano"><br>
<input type="submit" class="btn btn-default" value="Procurar" id="procura" name="procura">
